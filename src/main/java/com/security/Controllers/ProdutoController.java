...
@CrossOrigin(origins = "*") // Permite todas as origens. Ajuste conforme necessário.
...
public class ProdutoController {
    ...
    public ResponseEntity<List<Produto>> obterProdutosPorCategoria(@PathVariable("categoriaId") Long categoriaId) {        List<Produto> produtos = produtoService.getProdutosByCategoria(categoriaId);
        return ResponseEntity.ok(produtos);
    }
}
